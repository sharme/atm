...
<header class="am-topbar header">
  ...
  <div class="am-collapse am-topbar-collapse right" id="doc-topbar-collapse">
    ...
    <div class=" am-topbar-left am-form-inline am-topbar-right" role="search">
      ...
      <li><a href="solutions.jsp">解决方案</a></li>
      <li><a href="product-show.jsp">产品展示 </a></li>
      <li  class="hw-menu-active"><a href="customer-case.jsp">客户案例</a></li>
      <li><a href="service-center.jsp">服务中心 </a></li>
      <li><a href="news.jsp">新闻动态 </a></li>
      <li><a href="about-us.jsp">关于我们</a></li>
      <li><a href="recruit.jsp">招贤纳士 </a></li>
    </ul>
    </div>
	...
	<div class="am-container-1">
	 <div class="toppic-title left">
		...
		<div class="right toppic-progress">
			<span><a href="main/index.jsp" class="w-white">首页</a></span>
			<i class=" am-icon-arrow-circle-right w-white"></i>
			<span><a href="customer-case.jsp" class="w-white">客户案例</a></span>
		</div>
	</div>
</div>
  ...
  am-avg-md-3 am-avg-lg-4 am-gallery-bordered customer-case-ul" data-am-gallery="{  }" >
      <li>
        <div class="am-gallery-item">
            <a href="case-inform.jsp" class="">
            	<div class="customer-case-img">
              <img src="img/app1-1.png" />
             </div>
