...
<div class="shopNav">
    <div class="slideall" style="height: auto;">
                        ...
                        <ul class="category-list navTwo" id="js_climit_li">
                            <li>
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="./images/cake.png"></i><a class="ml-22" title="参展商">参展商</a></h3>
                                    <em>&gt;</em></div>
                                    ...
                                    <div class="area-in">
                                        <div class="area-bg">
                                            <div class="menu-srot">
                                                <div class="sort-side">
                                                    <dl class="dl-sort">
                                                        <dt><span title="参展商">日常展会</span></dt>
                                                        <dd><a title="蒸蛋糕" href="#"><span>家居</span></a></dd>
                                                        <dd><a title="脱水蛋糕" href="#"><span>家电</span></a></dd>
                                                        <dd><a title="瑞士卷" href="#"><span>家具</span></a></dd>
                                                    ...
                                                    <dl class="dl-sort">
                                                        <dt><span title="食品、饮料、烟酒">食品、饮料、烟酒</span></dt>
                                                        <dd><a title="蒸蛋糕" href="#"><span>食品</span></a></dd>
                                                        <dd><a title="脱水蛋糕" href="#"><span>饮料</span></a></dd>
                                                        <dd><a title="瑞士卷" href="#"><span>肉类</span></a></dd>
                                                        <dd><a title="软面包" href="#"><span>烟草</span></a></dd>
                                                        <dd><a title="马卡龙" href="#"><span>酒</span></a></dd>
                                                        <dd><a title="千层饼" href="#"><span>果蔬</span></a></dd>
                                                        <dd><a title="甜甜圈" href="#"><span>休闲食品</span></a></dd>
                                                        <%--<dd><a title="蒸三明治" href="#"><span>蒸三明治</span></a></dd>--%>
                                                        <%--<dd><a title="铜锣烧" href="#"><span>铜锣烧</span></a></dd>--%>
                                                    </dl>
                                                ...
                                                <div class="brand-side">
                                                    <dl class="dl-sort"><dt><span>近期热门展会</span></dt>
                            ...
                            <li >
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="./images/cookies.png"></i><a class="ml-22" title="饼干、膨化">搭建公司</a></h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                                    <div class="area-in">
                                        <div class="area-bg">
        ...
        <div class="marqueenTwo">
            <span class="marqueen-title"><i class="am-icon-volume-up am-icon-fw"></i>展会头条<em class="am-icon-angle-double-right"></em></span>
            <div class="demo">
